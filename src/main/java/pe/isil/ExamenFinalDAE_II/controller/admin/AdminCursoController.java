package pe.isil.ExamenFinalDAE_II.controller.admin;
...
public class AdminCursoController {
    ...
    String index(
        ...
        Page<Curso> cursos; //listado de cursos del tipo page
    ...
    String crear(@Validated Curso curso, BindingResult bindingResult, Model model, RedirectAttributes ra){
        ...
        ra.addFlashAttribute("msgExito", "El curso fué creado exitosamente");
